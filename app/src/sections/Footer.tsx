            ...
            {footerConfig.columns.map((column, colIndex) => (
              <div key={colIndex} className="flex flex-col" style={{ gap: 16 }}>
                ...
                {column.links.map((link, linkIdx) => (
                  <a
                    key={link}
                    href={column.urls && column.urls[linkIdx] ? column.urls[linkIdx] : "#"}
                    target={column.urls && column.urls[linkIdx] ? "_blank" : undefined}
                    rel={column.urls && column.urls[linkIdx] ? "noopener noreferrer" : undefined}
                    className="nav-link"
